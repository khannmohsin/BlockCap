...
source_markers = {
    "validator_registration.csv": "X",
    "non-validator_registration.csv": "D",
    "already_registered.csv": "o"
}
...
for node in os.listdir(NODE_ROOT):
    ...
    for csv_file in ["validator_registration.csv", "non-validator_registration.csv", "already_registered_check.csv"]:
...
marker_legend_handles = [
    mlines.Line2D([], [], color='black', marker='X', linestyle='None',
                  markersize=10, label='Validator Registration'),
    mlines.Line2D([], [], color='black', marker='D', linestyle='None',
                  markersize=10, label='Non-validator Registration'),
    mlines.Line2D([], [], color='black', marker='o', linestyle='None',
                  markersize=10, label='Pre-registered ')
]
...
plt.tight_layout()
plt.savefig("/Users/khannmohsin/VSCode_Projects/MyDisIoT_Project/Node_measurements/registeration_resource_usage.pdf", format="pdf", bbox_inches="tight")
# plt.show()
...
#     init_file = None
#     for fname in ["validator_registration.csv", "non-validator_registration.csv"]:
